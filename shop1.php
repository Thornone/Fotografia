...
<input type="hidden" name="hosted_button_id" value="C72MH9XGS7WFA">
        ...
        <section class="text-center well well-sm">
          <div class="container container-wide">
            ...
            <div class="row flow-offset-1">
              ...
              <div class="col-sm-6 col-md-4">
                <div class="thumbnail thumbnail-shop-catalog thumbnail-4 border-light"><a href="shop-product.html" class="hover-img"><img src="img/shop-4.jpg" alt=""></a>
                  <div class="caption">
                    <h3><a href="shop-product.html">SAVE IN STYLE</a></h3>
                    <p class="small text-darker lh-21">With the discount clothing</p><a href="shop-product.html" class="btn btn-primary btn-sm">shop now</a>
                  </div>
                </div>
              </div>
              <div class="col-sm-6 col-md-4">
                <div class="thumbnail thumbnail-shop-catalog thumbnail-4 border-light"><a href="shop-product.html" class="hover-img"><img src="img/shop-5.jpg" alt=""></a>
                  <div class="caption">
                    <h3><a href="shop-product.html">the new style</a></h3>
                    <p class="small text-darker lh-21">Men's Amazing Collection</p><a href="shop-product.html" class="btn btn-primary btn-sm">shop now</a>
                  </div>
                </div>
              </div>
              <div class="col-sm-6 col-md-4">
                <div class="thumbnail thumbnail-shop-catalog thumbnail-4 border-light"><a href="shop-product.html" class="hover-img"><img src="img/shop-6.jpg" alt=""></a>
                  <div class="caption">
                    <h3><a href="shop-product.html">Women's</a></h3>
                    <p class="small text-darker lh-21">New Arrivals</p><a href="shop-product.html" class="btn btn-primary btn-sm">shop now</a>
                  </div>
                </div>
              </div>
            </div>
