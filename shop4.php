    ...
    <div class="page">
      ...
      <div class="header-page text-center">
        <div class="container container-wide">
          <h1 class="pull-sm-left">Checkout</h1>
      ...
      <main class="page-content undefined">
        <section class="text-center text-sm-left well well-sm shop checkout">
          <div class="container container-wide">
            <div class="row">
              <div class="col-xs-12">
                <div class="row flow-offset-3">
                  <div class="col-sm-6">
                    ...
                    <p class="small text-darker">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Libero velit id eaque ex quae laboriosam nulla optio doloribus! Perspiciatis, libero, neque, perferendis at nisi optio</p>
                    <form method="post">
                      <div class="form-group">
                        <label for="example1"></label>
                        <input placeholder="name" type="text" name="user" id="example1" class="form-control">
                      </div>
                      <div class="form-group">
                        <label for="example2"></label>
                        <input placeholder="COMPANY NAME" type="text" name="pass" id="example2" class="form-control">
                      </div>
                      <div class="form-group">
                        <label for="example6"></label>
                        <input placeholder="ADDRESS" type="text" name="pass" id="example6" class="form-control">
                      </div>
                      <div class="form-group">
                        <label for="example3"></label>
                        <input placeholder="CITY / TOWN" type="text" name="pass" id="example3" class="form-control">
                      </div>
                      <div class="form-group">
                        <label for="example4"></label>
                        <input placeholder="EMAIL ADDRESS" type="text" name="pass" id="example4" class="form-control">
                      </div>
                      <div class="form-group">
                        <label for="example5"></label>
                        <input placeholder="PHONE" type="text" name="pass" id="example5" class="form-control">
                      </div>
                    </form>
                  </div>
                  <div class="col-sm-6">
                    ...
                    <form method="post">
                      <div class="form-group">
                        ...
                        <input placeholder="name" type="text" name="user" id="example7" class="form-control">
                      </div>
                      <div class="form-group">
                        <label for="example8"></label>
                        <input placeholder="COMPANY NAME" type="text" name="pass" id="example8" class="form-control">
                      </div>
                      <div class="form-group">
                        <label for="example9"></label>
                        <input placeholder="ADDRESS" type="text" name="pass" id="example9" class="form-control">
                      </div>
                      <div class="form-group">
                        <label for="example10"></label>
                        <input placeholder="CITY / TOWN" type="text" name="pass" id="example10" class="form-control">
                      </div>
                      <div class="form-group">
                        <label for="Text1"></label>
                        <textarea id="Text1" placeholder="NOTES *" class="form-control"></textarea>
                      </div>
                    </form>
                  </div>
                </div>
              ...
              <div class="col-xs-12 offset-4">
                <div class="row flow-offset-3">
                  <div class="col-sm-6">
                    ...
                    <div class="table-responsive">
                      <table class="table">
                        ...
                        <tbody class="small">
                          <tr>
                            <td><a href="shop-product.html" class="hover-img"><img src="img/shop-7.jpg" alt="" class="width-80"></a></td>
                            <td><a href="shop-product.html">Purse</a></td>
                            <td> &euro; 45</td>
                            <td> &euro; 90</td>
                          </tr>
                          <tr>
                            <td><a href="shop-product.html" class="hover-img"><img src="img/shop-8.jpg" alt="" class="width-80"></a></td>
                            <td><a href="shop-product.html">Shoes</a></td>
                            <td> &euro; 83</td>
                            <td> &euro; 415</td>
                          </tr>
                          <tr>
                            <td><a href="shop-product.html" class="hover-img"><img src="img/shop-9.jpg" alt="" class="width-80"></a></td>
                            <td><a href="shop-product.html">Hat</a></td>
                            <td> &euro; 34</td>
                            <td> &euro; 340</td>
                          </tr>
                        </tbody>
                  ...
                  <div class="col-sm-6">
                    <h3>Cart Totals</h3>
                    <p class="small total offset-3"><span>Cart Subtotal</span>  $106.94<br>
                      <span>Shipping</span> Free Delivery<br>
                      <span>Total</span>  $106.94<br>
                    ...
                    <div class="payment-variants">
                      <div class="radio">
                        <label>
                          <input type="radio" name="blankRadio" id="blankRadio1" value="option1"><span class="radio-field"></span><span class="h5">Direct Bank Transfer</span>
                        </label>
                      </div>
                      <div class="radio">
                        <label>
                          <input type="radio" name="blankRadio" id="blankRadio2" value="option2"><span class="radio-field"></span><span class="h5">Cheque Payment</span>
                        </label>
                      </div>
                      <div class="radio">
                        <label>
                          <input type="radio" name="blankRadio" id="blankRadio3" value="option3"><span class="radio-field"></span><span class="h5">Paypal</span>
                        </label>
                      </div>
                    </div><a href="#" class="btn btn-primary">send message</a>
                  </div>
                </div>
              </div>
            </div>
