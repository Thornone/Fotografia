    ...
    <div class="page">
      ...
      <div class="header-page text-center">
        <div class="container container-wide">
          <h1 class="pull-sm-left">Cart page</h1>
      ...
      <main class="page-content undefined">
        <section class="text-center text-sm-left well shop cart">
          <div class="container container-wide">
            <div class="row">
              <div class="col-xs-12 table-responsive">
                <table class="table">
                  ...
                  <thead>
                    <tr>
                      <th class="text-center text-sm-left"></th>
                      <th class="text-center text-sm-left"></th>
                      <th class="text-center text-sm-left">Product</th>
                      <th class="text-center text-sm-left">Unit Price</th>
                      <th class="text-center text-sm-left">Quantity</th>
                      <th class="text-center text-sm-left">Total</th>
                    </tr>
                  </thead>
                  <tbody class="small">
                    <tr>
                      <td><a href="#" class="fa-trash"></a></td>
                      ...
                      <td> &euro; 45</td>
                      <td><span class="quantity"><span class="count">-</span><span class="num">2</span><span class="count">+</span></span></td>
                      <td> &euro; 90</td>
                    </tr>
                    <tr>
                      <td><a href="#" class="fa-trash"></a></td>
                      ...
                      <td> &euro; 83</td>
                      <td><span class="quantity"><span class="count">-</span><span class="num">5</span><span class="count">+</span></span></td>
                      <td> &euro; 415</td>
                    </tr>
                    <tr>
                      <td><a href="#" class="fa-trash"></a></td>
                      ...
                      <td> &euro; 34</td>
                      <td><span class="quantity"><span class="count">-</span><span class="num">10</span><span class="count">+</span></span></td>
                      <td> &euro; 340</td>
                    </tr>
                  </tbody>
                </table>
              </div>
              <div class="col-xs-12 offset-2 text-sm-right"><a href="shop-checkout.html" class="btn btn-sm btn-primary">proceed to checkout</a><a href="shop-cart.html" class="btn btn-sm btn-primary">update cart</a></div>
              <div class="col-xs-12 offset-2 text-center text-md-left well-bottom">
                  ...
                  <div class="col-md-6">
                    ...
                    <form method="post">
                      <div class="form-group">
                        ...
                        <input placeholder="state / country" type="text" name="user" id="example1" class="form-control">
                      </div>
                      <div class="form-group">
                        <label for="example2"></label>
                        <input placeholder="postcode / zip" type="text" name="pass" id="example2" class="form-control">
                      </div><a href="#" class="btn btn-sm btn-primary">update totals</a>
                    </form>
                  </div>
                  <div class="col-md-3">
                    <h3>Cart Totals</h3>
                    <p class="small total"><span>Cart Subtotal</span> $106.94<br>
