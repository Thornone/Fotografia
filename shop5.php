    ...
    <div class="page">
      ...
      <div class="header-page text-center">
        <div class="container container-wide">
          <h1 class="pull-sm-left">Invoice page</h1>
      ...
      <main class="page-content undefined">
        <section class="text-center text-sm-left well-top well-bottom shop invoice">
          <div class="container container-wide">
            <div class="row">
              <div class="col-xs-12 well border-bottom">
                <div class="row flow-offset-1">
                  <div class="col-sm-6">
                    <h3>Client Information</h3>
                    <div class="shop-client-info small text-darker lh-21">
                      First Name: JOHN <br>
                      Last Name: NILSON <br>
                      Country: CANADA <br>
                      DOB: YYYY/MM/DD <br>
                  ...
                  <div class="col-sm-6">
                    ...
                    <div class="shop-client-info small text-darker lh-21">
                      Bank Name: 123456789012 <br>
                      Account Number: 123456789012 <br>
                      SWIFT Code: 123DEMO45DEMO <br>
                      V.A.T Reg #: 678DEMO45545 <br>
                    </div>
                  </div>
                </div>
              </div>
              <div class="col-xs-12 well">
                ...
                <div class="table-responsive">
                  <table class="table text-left">
                    ...
                    <thead>
                      <tr class="font-secondary text-uppercase text-regular">
                    ...
                    <tbody class="small">
                      <tr>
                        ...
                        <td><a href="shop-product.html"> At vero eos et accusamus etofficia mollitia</a></td>
                        <td>34</td>
                        <td>&euro; 45</td>
                        <td>&euro; 434</td>
                      </tr>
                      <tr>
                        <td>2</td>
                        <td><a href="shop-product.html"> Bag</a></td>
                        <td><a href="shop-product.html"> Verode eoset accusamus etofficia deserunt</a></td>
                        <td>67</td>
                        <td>&euro; 56</td>
                        <td>&euro; 982</td>
                      </tr>
                      <tr>
                        ...
                        <td><a href="shop-product.html"> Etquas molestias deexcepturi dasint</a></td>
                        <td>12</td>
                        <td>&euro; 83</td>
                        <td>&euro; 871</td>
                      </tr>
                      <tr>
                        ...
                        <td><a href="shop-product.html"> Atofficia droeos etofficia taccusamus</a></td>
                        <td>26</td>
                        <td>&euro; 33</td>
                        <td>&euro; 76</td>
                      </tr>
                ...
                <div class="row offset-3 flow-offset-1">
                  <div class="col-sm-6 col-md-8 col-lg-9">
                    <div class="address small contact-info-3">
                      8901 Marmora Road, <br>
                      Glasgow, D04 89GR.
                      <dl>
                        <dt>Phone:</dt>
                        <dd><a href="callto:#">800 123 3456</a></dd>
                        <dt>Fax:</dt>
                        <dd><a href="callto:#">800 123 3456</a></dd>
                      </dl>
                      <dl>
                        <dt>Email:</dt>
                        <dd><a href="mailto:#" class="text-primary text-underline">info@demolink.org</a></dd>
                      </dl>
                    </div>
                  </div>
                  <div class="col-sm-6 col-md-3 col-lg-2 pull-md-right total">
                    <p class="small">
                      Total Amount: $109365<br>
                      Discount: 14.8%<br>
                      VAT ($6): $8371<br>
                      Grand Total: $101486<br>
                    </p><a href="#" class="btn btn-sm btn-primary">Submit the invoice</a>
                  </div>
                  <div class="col-sm-12 col-md-1"><a href="#" class="fa-print small text-primary text-underline custom-offset">Print</a></div>
                </div>
              </div>
            </div>
          </div>
