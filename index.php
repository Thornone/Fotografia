    ...
    <div class="page">
      ...
      <header class="page-header">
        ...
        <div class="rd-navbar-wrap">
          <nav class="rd-navbar top-panel-none-items nav-transparent navbar-shadow" data-layout="rd-navbar-fixed" data-hover-on="false" data-stick-up="false" data-sm-layout="rd-navbar-fullwidth" data-lg-layout="rd-navbar-static">
            ...
            <div class="rd-navbar-inner">
              ...
              <div class="rd-navbar-nav-wrap"><a href="shop-cart.html" class="material-icons-shopping_cart"></a>
                ...
                <ul class="rd-navbar-nav">
                  <li class="active"><a href="./">Home <small>Let`s start</small></a></li>
                  ...
                  <li class="dropdown-megamenu"><a href="#">Pages <small>Templates</small></a>
                  ...
                  <li><a href="#">Shop <small>Buy now</small></a>
                    <ul class="rd-navbar-dropdown">
                      <li><a href="shop1.php">Product catalog</a></li>
                      <li><a href="shop2.php">Single product</a></li>
                      <li><a href="shop3.php">Shopping cart</a></li>
                      <li><a href="shop4.php">Checkout</a></li>
                      <li><a href="shop5.php">Invoice page</a></li>
                    </ul>
                  </li>
        ...
        <section>
          <!--Swiper-->
          <div data-autoplay="5000" data-slide-effect="fade" data-loop="false" data-height="36,45833333333333%" data-min-height="400px" class="swiper-container swiper-slider">
            <div class="container container-wide slider-container">
              <div class="jumbotron text-center bg-btn">
                <h1 data-wow-duration="2s" class="wow fadeIn">m&#216;DERN&#216;<small data-wow-duration="2s" class="wow fadeIn">Clean and fully responsive Template.</small></h1>
                <p data-wow-duration="2s" class="big wow fadeIn"></p>
              </div>
            </div>
            <div class="swiper-wrapper">
              <div data-slide-bg="img/slide-1.jpg" class="swiper-slide">
                <div class="swiper-slide-caption"></div>
              </div>
              <div data-slide-bg="img/slide-2.jpg" class="swiper-slide">
                <div class="swiper-slide-caption"></div>
              </div>
              <div data-slide-bg="img/slide-3.jpg" class="swiper-slide">
                <div class="swiper-slide-caption"></div>
              </div>
            </div>
            <!--Swiper Pagination-->
      ...
      <main class="page-content undefined">
          ...
          <div class="container container-wide">
            ...
            <div data-lightbox="gallery" class="row row-no-gutter offset-2">
              <div class="col-xs-6 col-sm-6 col-md-3">
                <div class="img-thumbnail text-center"><a href="img/index-1_original.jpg" data-lightbox="image"><img src="img/index-1.jpg" alt="" class="img-wide">
                    <div class="caption">
                      <h1>DESIGN OBJECT</h1>
                      <p>Web Design</p>
              ...
              <div class="col-xs-6 col-sm-6 col-md-3">
                <div class="img-thumbnail text-center"><a href="img/index-2_original.jpg" data-lightbox="image"><img src="img/index-2.jpg" alt="" class="img-wide">
                    <div class="caption">
                      <h1>DESIGN OBJECT</h1>
                      <p>Web Design</p>
                    </div><span class="overlay"></span></a></div>
              ...
              <div class="col-xs-6 col-sm-6 col-md-3">
                <div class="img-thumbnail text-center"><a href="img/index-3_original.jpg" data-lightbox="image"><img src="img/index-3.jpg" alt="" class="img-wide">
                    <div class="caption">
                      <h1>DESIGN OBJECT</h1>
                      <p>Web Design</p>
                    </div><span class="overlay"></span></a></div>
              ...
              <div class="col-xs-6 col-sm-6 col-md-3">
                <div class="img-thumbnail text-center"><a href="img/index-4_original.jpg" data-lightbox="image"><img src="img/index-4.jpg" alt="" class="img-wide">
                    <div class="caption">
                      <h1>DESIGN OBJECT</h1>
                      <p>Web Design</p>
                    </div><span class="overlay"></span></a></div>
              ...
              <div class="col-xs-6 col-sm-6 col-md-3">
                <div class="img-thumbnail text-center"><a href="img/index-5_original.jpg" data-lightbox="image"><img src="img/index-5.jpg" alt="" class="img-wide">
                    <div class="caption">
                      <h1>DESIGN OBJECT</h1>
                      <p>Web Design</p>
                    </div><span class="overlay"></span></a></div>
              ...
              <div class="col-xs-6 col-sm-6 col-md-3">
                <div class="img-thumbnail text-center"><a href="img/index-6_original.jpg" data-lightbox="image"><img src="img/index-6.jpg" alt="" class="img-wide">
                    <div class="caption">
                      <h1>DESIGN OBJECT</h1>
                      <p>Web Design</p>
                    </div><span class="overlay"></span></a></div>
              ...
              <div class="col-xs-6 col-sm-6 col-md-3">
                <div class="img-thumbnail text-center"><a href="img/index-7_original.jpg" data-lightbox="image"><img src="img/index-7.jpg" alt="" class="img-wide">
                    <div class="caption">
                      <h1>DESIGN OBJECT</h1>
                      <p>Web Design</p>
                    </div><span class="overlay"></span></a></div>
              ...
              <div class="col-xs-6 col-sm-6 col-md-3">
                <div class="img-thumbnail text-center"><a href="img/index-8_original.jpg" data-lightbox="image"><img src="img/index-8.jpg" alt="" class="img-wide">
                    <div class="caption">
                      <h1>DESIGN OBJECT</h1>
                      <p>Web Design</p>
                    </div><span class="overlay"></span></a></div>
        ...
        <!--Start section-->
        <section class="well text-center text-sm-left">
          <div class="container container-wide">
            <div class="row flow-offset-1">
              <div class="col-sm-6 col-md-4">
                <div data-wow-duration="1s" class="box-sm box-hover-1 wow fadeIn">
                  <div class="box__left"><span class="icon icon-lg icon-primary fa-compress"></span></div>
                  <div class="box__body">
                    <h4 class="text-bold inset-1">Responsive layout</h4>
                    <p class="small text-darker">Aenean commodo ligula eget dolor. Aen ean massa. Lorem ipsum dolor sit amet, consec tetuer adipis elit, aliquam eget nibh etlibura.</p>
                  </div>
                </div>
              </div>
              <div class="col-sm-6 col-md-4">
                <div data-wow-duration="1s" class="box-sm box-hover-1 wow fadeIn">
                  <div class="box__left"><span class="icon icon-lg icon-primary fa-leaf"></span></div>
                  <div class="box__body">
                    <h4 class="text-bold inset-1">Retina ready graphics</h4>
                    <p class="small text-darker">Aenean commodo ligula eget dolor. Aen ean massa. Lorem ipsum dolor sit amet, consec tetuer adipis elit, aliquam eget nibh etlibura.</p>
                  </div>
                </div>
              </div>
              <div class="col-sm-6 col-md-4">
                <div data-wow-duration="1s" class="box-sm box-hover-1 wow fadeIn">
                  <div class="box__left"><span class="icon icon-lg icon-primary fa-industry"></span></div>
                  <div class="box__body">
                    <h4 class="text-bold inset-1">Powerful performance</h4>
                    <p class="small text-darker">Aenean commodo ligula eget dolor. Aen ean massa. Lorem ipsum dolor sit amet, consec tetuer adipis elit, aliquam eget nibh etlibura.</p>
                  </div>
                </div>
              </div>
              <div class="col-sm-6 col-md-4">
                <div data-wow-duration="2s" class="box-sm box-hover-1 wow fadeIn">
                  <div class="box__left"><span class="icon icon-lg icon-primary fa-video-camera"></span></div>
                  <div class="box__body">
                    <h4 class="text-bold inset-1">html5 video</h4>
                    <p class="small text-darker">Aenean commodo ligula eget dolor. Aen ean massa. Lorem ipsum dolor sit amet, consec tetuer adipis elit, aliquam eget nibh etlibura.</p>
                  </div>
                </div>
              </div>
              <div class="col-sm-6 col-md-4">
                <div data-wow-duration="2s" class="box-sm box-hover-1 wow fadeIn">
                  <div class="box__left"><span class="icon icon-lg icon-primary fa-bolt"></span></div>
                  <div class="box__body">
                    <h4 class="text-bold inset-1">parallax support</h4>
                    <p class="small text-darker">Aenean commodo ligula eget dolor. Aen ean massa. Lorem ipsum dolor sit amet, consec tetuer adipis elit, aliquam eget nibh etlibura.</p>
                  </div>
                </div>
              </div>
              <div class="col-sm-6 col-md-4">
                <div data-wow-duration="2s" class="box-sm box-hover-1 wow fadeIn">
                  <div class="box__left"><span class="icon icon-lg icon-primary fa-paint-brush"></span></div>
                  <div class="box__body">
                    <h4 class="text-bold inset-1">endless posibilities</h4>
                    <p class="small text-darker">
                      Aenean commodo ligula eget dolor. Aen ean massa. Lorem ipsum dolor sit amet, consec tetuer adipis elit, aliquam eget nibh etlibura.
        ...
        <!--Start section-->
        <section class="bg-dark-blue-2 well well-sm text-center count-section">
          <div class="container counter-panel container-wide">
            <div class="row flow-offset-3">
              <div class="col-xs-12 col-sm-6 col-md-3"><span class="fa-clock-o icon-xl text-primary"></span>
                <div data-from="0" data-to="3652" class="counter"></div>
                <hr>
                <h4 class="text-bold text-white">tickets answered</h4>
              </div>
              <div class="col-xs-12 col-sm-6 col-md-3"><span class="fa-font icon-xl text-primary"></span>
                <div data-from="0" data-to="156" class="counter"></div>
                <hr>
                <h4 class="text-bold text-white">google fonts</h4>
              </div>
              <div class="col-xs-12 col-sm-6 col-md-3"><span class="fa-houzz icon-xl text-primary"></span>
                <div data-from="0" data-to="699" class="counter"></div>
                <hr>
                <h4 class="text-bold text-white">features added</h4>
              </div>
              <div class="col-xs-12 col-sm-6 col-md-3"><span class="fa-users icon-xl text-primary"></span>
                <div data-from="0" data-to="4573" class="counter"></div>
                <hr>
                <h4 class="text-bold text-white">theme users</h4>
              </div>
            </div>
          </div>
        </section>
        ...
        <!--Start section-->
        <section class="well well-sm-bottom text-center">
          <div class="container container-wide">
            <h1>Our team</h1>
            <hr>
            <div class="row flow-offset-3 offset-2">
              <div class="col-sm-4">
                <div data-wow-delay=".2s" class="thumbnail thumbnail-4 wow fadeIn"><img src="img/index-12.jpg" alt="" class="img-wide">
                  <div class="caption">
                    <h1 class="small"><a href="team-member.html">James Brown Mahatma</a></h1>
                    <h4 class="text-dark">CEO & Marketing Manager</h4>
                    <hr>
                    <ul class="list-inline text-dark big">
              ...
              <div class="col-sm-4">
                <div data-wow-delay=".4s" class="thumbnail thumbnail-4 wow fadeIn"><img src="img/index-13.jpg" alt="" class="img-wide">
                  <div class="caption">
                    <h1 class="small"><a href="team-member.html">Sonya Readone</a></h1>
                    <h4 class="text-dark">PR manager</h4>
                    <hr>
                    <ul class="list-inline text-dark big">
                      <li><a href="#" class="fa-google-plus"></a></li>
                      <li><a href="#" class="fa-pinterest"></a></li>
              ...
              <div class="col-sm-4">
                <div data-wow-delay=".6s" class="thumbnail thumbnail-4 wow fadeIn"><img src="img/index-14.jpg" alt="" class="img-wide">
                  <div class="caption">
                    <h1 class="small"><a href="team-member.html">Jimmie Luckface</a></h1>
                    <h4 class="text-dark">Account Manager</h4>
                    <hr>
                    <ul class="list-inline text-dark big">
                      <li><a href="#" class="fa-google-plus"></a></li>
                      <li><a href="#" class="fa-pinterest"></a></li>
        ...
        <!--Start section-->
        <section class="well text-center bg-dark-blue-3">
          <div class="container container-wide">
            <h1 class="text-white inset-1">Latest from the blog</h1>
            <hr>
            <!--Owl Carousel-->
            <div data-items="1" data-sm-items="2" data-md-items="3" data-dots="true" data-margin="30" data-dots-each="true" class="owl-carousel bg-owl-dark">
              <div class="owl-item">
                <article class="thumbnail thumbnail-4 text-md-left blog-post"><a href="blog_post.html" class="hover-img"><img src="img/index-15.jpg" alt="" class="img-wide"></a>
                  <div class="caption bg-white">
                    <h2><a href="blog_post.html" class="text-base">trends in UX Design</a></h2>
                    <p class="text-darker">Aenean commodo ligula eget dolor. Aen  ean massa. Lorem ipsum dolor sit amet, consec tetuer adipis elit, aliquam eget nibh etlibura. Aenean commodo ligula</p>
                    <time datetime="2016" class="small text-dark text-uppercase font-secondary">November 12, 2015</time>
                  </div>
                </article>
              </div>
              <div class="owl-item">
                <article class="thumbnail thumbnail-4 text-md-left blog-post"><a href="blog_post.html" class="hover-img"><img src="img/index-16.jpg" alt="" class="img-wide"></a>
                  <div class="caption bg-white">
              ...
              <div class="owl-item">
                <article class="thumbnail thumbnail-4 text-md-left blog-post"><a href="blog_post.html" class="hover-img"><img src="img/index-17.jpg" alt="" class="img-wide"></a>
                  <div class="caption bg-white">
        ...
        <section class="well well-sm">
          <div class="container container-wide">
            <ul class="flex-list">
              <li><a href="clients.html"><img src="img/index-18.jpg" alt="" class="img-wide"></a></li>
              <li><a href="clients.html"><img src="img/index-19.jpg" alt="" class="img-wide"></a></li>
              <li><a href="clients.html"><img src="img/index-20.jpg" alt="" class="img-wide"></a></li>
              <li><a href="clients.html"><img src="img/index-21.jpg" alt="" class="img-wide"></a></li>
            </ul>
          </div>
        </section>
      </main>
