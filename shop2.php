    ...
    <div class="page">
            ...
            <div class="rd-navbar-inner">
              ...
              <div class="rd-navbar-nav-wrap"><a href="shop-cart.html" class="material-icons-shopping_cart"></a>
                ...
                <ul class="rd-navbar-nav">
                  ...
                  <li class="active"><a href="#">Shop <small>Buy now</small></a>
                    <ul class="rd-navbar-dropdown">
                      <li><a href="shop-catalog.html">Product catalog</a></li>
                      <li><a href="shop-product.html">Single product</a></li>
                      <li><a href="shop-cart.html">Shopping cart</a></li>
      ...
      <div class="header-page text-center">
        <div class="container container-wide">
          <h1 class="pull-sm-left">Single Product</h1>
              ...
              <div class="col-xs-12 well well-sm border-bottom">
                <div data-lightbox="gallery" class="row">
                  <div class="col-sm-4 col-md-4">
                    <div class="thumbnail thumbnail-4"><a href="img/product-1_original.jpg" data-lightbox="image" id="product-img-1" class="hover-img active"><img src="img/product-1.jpg" alt="" class="img-wide"></a><a href="img/product-2_original.jpg" data-lightbox="image" id="product-img-2" class="hover-img"><img src="img/product-2.jpg" alt="" class="img-wide"></a></div>
                  </div>
                  <div class="col-sm-8 col-md-5">
                    <div class="flex-box">
                      <div class="product-info-block border-bottom">
                        <!--span.price.pull-md-right #[span &euro;] 12-->
                        <div class="pricing-box pull-md-right"><span class="price">12</span></div>
                        <h3>Lastest product arrivals</h3>
                        <p class="small text-darker">New Product Design</p><a href="shop-cart.html" class="btn btn-sm btn-primary">shop now</a>
                      </div>
                      <div class="product-info-block border-bottom">
                        <p class="small lh-21">
                          Lorem ipsum dolor sit amet, consectetur adipisicing elit. Libero velit id eaque ex quae laboriosam nulla optio doloribus! Perspiciatis, libero, neque, perferendis at nisi optio dolor!<br><br>
                              Perspiciatis ad eveniet ea quasi debitis quos laborum eum reprehenderit
                        </p>
                      </div>
                      <div class="product-img-block shop-gallery"><span data-shop-gallery="product-img-1" class="img-mini"><img src="img/product-1_mini.jpg" alt="" class="img-wide"></span><span data-shop-gallery="product-img-2" class="img-mini"><img src="img/product-2_mini.jpg" alt="" class="img-wide"></span></div>
                    </div>
                  </div>
                  <div class="col-sm-12 col-md-3 text-center text-md-left">
                    <div class="box-md box--inset inset-1">
                      <div class="box__left"><span class="icon-xl fa-industry"></span></div>
                      <div class="box__body">
                        <h4 class="text-bold"><a href="#">100% ORIGINAL</a></h4>
                        <p class="small lh-21 text-darker">Aenean tcommodo ligula eget dolor. Aen ean massa. Lorem</p>
                      </div>
                    </div>
                    <div class="box-md box--inset">
                      <div class="box__left"><span class="icon-xl fa-pagelines"></span></div>
                      <div class="box__body">
                        <h4 class="text-bold"><a href="#">PAYMENT OPTIONS</a></h4>
                        <p class="small lh-21 text-darker">Aenean tcommodo ligula eget dolor. Aen ean massa. Lorem</p>
                      </div>
                    </div>
                    <div class="box-md box--inset">
                      <div class="box__left"><span class="icon-xl fa-child"></span></div>
                      <div class="box__body">
                        <h4 class="text-bold"><a href="#">FREE SHIPPING</a></h4>
                        <p class="small lh-21 text-darker">Aenean tcommodo ligula eget dolor. Aen ean massa. Lorem</p>
                      </div>
                    </div>
                    <div class="box-md box--inset">
                      <div class="box__left"><span class="icon-xl fa-file-o"></span></div>
                      <div class="box__body">
                        <h4 class="text-bold"><a href="#">30-DAY RETURN</a></h4>
                        <p class="small lh-21 text-darker">
                          Aenean tcommodo ligula eget dolor. Aen ean massa. Lorem
        ...
        <section class="text-center well well-sm">
          <div class="container container-wide">
            ...
            <div class="row flow-offset-1">
              <div class="col-sm-4 col-md-4">
                <div class="thumbnail thumbnail-shop-catalog thumbnail-4 border-light"><a href="shop-product.html" class="hover-img"><img src="img/shop-1.jpg" alt=""></a>
                  <div class="caption">
                    <h3><a href="shop-product.html">Men's Footwear</a></h3>
                    <p class="small text-darker lh-21">Up to 50% Off</p><a href="shop-product.html" class="btn btn-primary btn-sm">shop now</a>
                  </div>
                </div>
              </div>
              <div class="col-sm-4 col-md-4">
                <div class="thumbnail thumbnail-shop-catalog thumbnail-4 border-light"><a href="shop-product.html" class="hover-img"><img src="img/shop-2.jpg" alt=""></a>
                  <div class="caption">
                    <h3><a href="shop-product.html">Lastest product arrivals</a></h3>
                    <p class="small text-darker lh-21">New Designs Available</p><a href="shop-product.html" class="btn btn-primary btn-sm">shop now</a>
                  </div>
                </div>
              </div>
              <div class="col-sm-4 col-md-4">
                <div class="thumbnail thumbnail-shop-catalog thumbnail-4 border-light"><a href="shop-product.html" class="hover-img"><img src="img/shop-3.jpg" alt=""></a>
                  <div class="caption">
                    <h3><a href="shop-product.html">the new style</a></h3>
                    <p class="small text-darker lh-21">New Trend from Top Brands</p><a href="shop-product.html" class="btn btn-primary btn-sm">shop now</a>
                  </div>
                </div>
              </div>
            </div>
